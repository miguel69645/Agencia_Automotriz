    ...
    <main>
        <section class="login-section">
            <div class="login-container">
                ...
                <form action="../a_actualizar/categoriaupdate.php?ID_Categoria=<?=$id?>" method="post" class="login-form" id="categorias-form">
                    <div class="input-container">
                        <label for="nombre2">Nombre:</label>
                        <input type="text" id="nombre2" name="nombre2" value="<?php echo isset($nombre) ? $nombre : ''; ?>" required>
                    </div>
                    <div class="input-container">
                        <label for="descripcion1">Descripcion:</label>
                        <input type="text" id="descripcion1" name="descripcion1" value="<?php echo isset($descripcion) ? $descripcion : ''; ?>" required>
                    </div>
                    <div class="input-container">
