...
<body>
    ...
    <div class="car-details">
        <div class="car-info">
            <h2>Detalles:</h2>
            <p><strong>Nombre:</strong> Honda CR-V 2023</p>
            <p><strong>Marca:</strong> Honda</p>
            <p><strong>Modelo:</strong> CR-V 2023</p>
            <p><strong>Descripción:</strong> El Honda CR-V 2023 es un SUV compacto que destaca por su versatilidad,
                espacio y tecnología avanzada. Con un diseño moderno y funciones prácticas, el CR-V ofrece un equilibrio
                excepcional entre comodidad en la conducción diaria y capacidad para aventuras fuera de la carretera.
            </p>
            ...
            <p><strong>Interior:</strong> El interior del CR-V 2023 destaca por su amplitud, con asientos cómodos y una
                variedad de tecnologías, incluyendo sistemas de infoentretenimiento intuitivos y características de
                seguridad avanzadas.</p>
        </div>
        <img id="car-image" src="../img/coches-colores/car-14.png" alt="Coche Blanco">
        <div class="info">
            <h2>Honda CR-V</h2>
            <p>Precio: $25,000</p>
            <p>Color:
            ...
            <button class="buy-button" data-id="14">Comprar</button>
        </div>
    </div>
    <footer>
