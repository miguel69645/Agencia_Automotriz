...
<body>
    ...
    <div class="car-details">
        <div class="car-info">
            <h2>Detalles:</h2>
            <p><strong>Nombre:</strong> Toyota Corolla 2023</p>
            <p><strong>Marca:</strong> Toyota</p>
            <p><strong>Modelo:</strong> Corolla</p>
            <p><strong>Descripción:</strong> El Toyota Corolla 2023 representa la última evolución de la emblemática
                línea de automóviles compactos. Con un diseño moderno y prestaciones avanzadas, el Corolla continúa
                siendo un referente en confiabilidad y eficiencia, manteniendo su estatus como uno de los automóviles
                más vendidos en el mundo.</p>
            <h3>Especificaciones Clave:</h3>
            <p><strong>Motor:</strong> Opciones de motorización eficiente, como motores de cuatro cilindros.</p>
            <p><strong>Transmisión:</strong> Disponible con transmisión manual o automática para adaptarse a las
                preferencias del conductor.</p>
            <p><strong>Interior:</strong> El interior del Corolla 2023 ofrece comodidad y tecnología avanzada, con
                materiales de calidad y características centradas en la conectividad y seguridad del conductor.</p>
        </div>
        <img id="car-image" src="../img/coches-colores/car-2/blanco.png" alt="Coche Blanco">
        <div class="info">
            <h2>Corolla 2023</h2>
            <p>Precio: $25,000</p>
            <p>Color:
    ...
    <script>
        function updateCarImage() {
            ...
            var imagePath = '../img/coches-colores/car-2/' + selectedColor + '.png';
