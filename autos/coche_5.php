...
<body>
    ...
    <div class="car-details">
        <div class="car-info">
            <h2>Detalles:</h2>
            <p><strong>Nombre:</strong> Chevrolet Corvette C8</p>
            <p><strong>Marca:</strong> Chevrolet</p>
            <p><strong>Modelo:</strong> 2023</p>
            <p><strong>Descripción:</strong> El Chevrolet Corvette C8 es la encarnación de la ingeniería de alto
                rendimiento y el diseño aerodinámico. Como el primer Corvette de motor central, el C8 establece nuevos
                estándares en cuanto a potencia, velocidad y estilo, ofreciendo una experiencia de conducción
                emocionante y sofisticada.</p>
            <h3>Especificaciones Clave:</h3>
            <p><strong>Motor:</strong> Motor V8 de alto rendimiento montado en posición central, proporcionando una
                potencia excepcional y una respuesta instantánea del acelerador.</p>
            <p><strong>Transmisión:</strong> Equipado con una transmisión de doble embrague y ocho velocidades que
                ofrece cambios de marcha rápidos y precisos.</p>
            <p><strong>Interior:</strong> El interior del Corvette C8 combina lujo y tecnología, con asientos
                deportivos, materiales de alta calidad y un avanzado sistema de infoentretenimiento.</p>
        </div>
        <img id="car-image" src="../img/coches-colores/car-5.png" alt="Coche Blanco">
        <div class="info">
            <h2>Corvette C8</h2>
            <p>Precio: $25,000</p>
            <p>Color:
